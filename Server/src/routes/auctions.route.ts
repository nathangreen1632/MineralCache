...
import { buyNow, placeBid, listAuctions, getAuction, getMinimumBid, listWatchedAuctions } from '../controllers/auctions.controller.js';
...
router.get('/watchlist/me', requireAuth, listWatchedAuctions);
