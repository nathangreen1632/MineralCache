            ...
            return (
              <tr key={v.id} className="border-t" style={{ borderColor: 'var(--theme-border)' }}>
                <td className="px-3 py-2 align-top">
                  ...
                  {createdAtLabel && (
                    <div className="text-xs" style={{ color: 'var(--theme-text)' }}>
                      Applied: {createdAtLabel}
                    </div>
                  )}
                  {bioText && (
                    <div className="mt-1 text-xs" style={{ color: 'var(--theme-text)' }}>
                      {bioText}
                    </div>
                  )}
                  {v.country && (
                    <div className="mt-1 text-xs uppercase" style={{ color: 'var(--theme-text)' }}>
                      Country: {v.country}
                    </div>
                  )}
                </td>
